...
namespace WinForms.Inventory
{
    ...
    {
        //Path to the file
        private static readonly string Path = @"C:\Users\HP\source\repos\WinForms.Inventory\WinForms.Inventory\grocery_inventory_items.txt";
        ...
        //Deleting an item from the list and saving the updated list to the file using index
